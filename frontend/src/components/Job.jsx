...
const Job = ({job}) => {
    ...
    return (
        <div className='bg-white rounded-xl md:rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 hover:border-blue-300 transition-all duration-300 p-4 md:p-6 flex flex-col h-full group hover:scale-105 hover:-translate-y-2 cursor-pointer'>
            <style>{`
            ...
            <div className='job-card-content flex items-center justify-between mb-3 md:mb-4'>
                ...
                <Button variant="ghost" className="bookmark-btn rounded-full hover:bg-blue-50 transition-all duration-300 active:scale-95" size="icon"><Bookmark className='text-gray-400 group-hover:text-blue-600 w-4 h-4 md:w-5 md:h-5 transition-colors duration-300' /></Button>
            </div>
            ...
            <div className='job-card-content flex items-center gap-2 md:gap-3 mb-3 md:mb-4 group-hover:opacity-100 transition-all duration-300'>
                <div className='h-10 md:h-12 w-10 md:w-12 rounded-lg bg-gradient-to-br from-blue-100 to-blue-100 flex items-center justify-center border border-blue-200 flex-shrink-0 group-hover:shadow-md transition-all duration-300'>
                    <Avatar className='h-8 md:h-10 w-8 md:w-10'>
                        <AvatarImage src={job?.company?.logo || "/src/assets/blog_default.webp"} />
                    </Avatar>
                </div>
                <div>
                    <h2 className='font-bold text-sm md:text-base text-gray-900 line-clamp-1 group-hover:text-blue-600 transition-colors duration-300'>{job?.company?.name}</h2>
                    <p className='text-xs md:text-sm text-gray-500'>India</p>
                </div>
            </div>

            <h1 className='job-card-content font-bold text-base md:text-lg lg:text-xl text-gray-900 mb-2 line-clamp-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-blue-600 group-hover:bg-clip-text transition-all duration-300'>{job?.title}</h1>
            ...
            <div className='job-card-content flex items-center gap-2 mt-auto mb-3 md:mb-4 flex-wrap'>
                <Badge className='bg-blue-100 text-blue-700 border border-blue-200 text-xs md:text-sm group-hover:bg-blue-200 group-hover:shadow-md transition-all duration-300'>{job?.position} Positions</Badge>
