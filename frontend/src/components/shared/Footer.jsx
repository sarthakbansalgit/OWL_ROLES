...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 text-white py-12 md:py-16 border-t-2 border-purple-500">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 mb-8 md:mb-12">
          {/* Brand Section */}
          <div className="col-span-2 md:col-span-1">
            <h2 className='text-2xl md:text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2 md:mb-3'>Owl Roles</h2>
          ...
          <div>
            ...
            <ul className="space-y-1 md:space-y-2 text-gray-300 text-xs md:text-sm">
              <li><a href="/" className="hover:text-purple-400 transition">Browse Jobs</a></li>
              <li><a href="/browse" className="hover:text-purple-400 transition">Search Jobs</a></li>
              <li><a href="/profile" className="hover:text-purple-400 transition">My Profile</a></li>
              <li><a href="/browse" className="hover:text-purple-400 transition">Career Tips</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 md:space-y-2 text-gray-300 text-xs md:text-sm">
              <li><a href="/admin/companies" className="hover:text-purple-400 transition">Post Jobs</a></li>
              <li><a href="/admin/companies" className="hover:text-purple-400 transition">Pricing</a></li>
              <li><a href="/admin" className="hover:text-purple-400 transition">Dashboard</a></li>
              <li><a href="/" className="hover:text-purple-400 transition">Company Info</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-2 md:gap-4">
              <a href="#" className="w-8 md:w-10 h-8 md:h-10 rounded-full bg-gray-800 hover:bg-purple-600 flex items-center justify-center transition-all duration-300">
