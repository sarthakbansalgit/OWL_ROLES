            ...
            <div className='flex items-center justify-between mx-auto max-w-7xl h-14 md:h-16 px-4'>
                ...
                <div className='hidden md:flex items-center gap-12'>
                    <ul className='flex font-semibold items-center gap-8'>
                        {user && user.role === 'recruiter' ? (
                            <>
                                <li className='text-gray-700 hover:text-blue-600 transition-colors cursor-pointer'><Link to="/hr/profile">My Company</Link></li>
                            ...
                            <PopoverContent className="w-72 bg-white border border-gray-200 rounded-2xl shadow-xl p-4">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {user?.role === 'recruiter' && <Link to="/hr/profile" className="block p-2 text-gray-700 hover:bg-blue-50 rounded text-sm">My Company</Link>}
