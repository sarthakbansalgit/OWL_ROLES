...
const Info1 = () => {
  return (
    <div className="py-12 md:py-20 bg-gradient-to-b from-transparent via-purple-50 to-blue-50 w-full">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-12 md:mb-16">
          <h1 className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-2 md:mb-4" data-aos="fade-in">
            Accessibility <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">out of the box.</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-4 md:space-y-6" data-aos="fade-in">
            <div className="grid gap-3 md:gap-4">
              {[
                ...
                <div key={idx} className="flex items-center gap-2 md:gap-3 p-3 md:p-4 bg-white rounded-lg shadow-md hover:shadow-lg border border-purple-100 transition-all">
            ...
            <Link to="/learn-more">
              <Button className="mt-4 md:mt-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-2 md:py-3 px-4 md:px-6 rounded-lg text-sm md:text-base">
                Learn More →
              </Button>
            </Link>
          </div>
          ...
          <div className="flex justify-center mt-8 md:mt-0">
            <div className="bg-gradient-to-br from-purple-500 via-pink-500 to-purple-600 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl text-white w-full max-w-sm">
              <div className="flex justify-end mb-3 md:mb-4">
                <HoverCard>
                  <HoverCardTrigger className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-purple-600 font-bold cursor-pointer text-sm">
                    ⓘ
                  </HoverCardTrigger>
