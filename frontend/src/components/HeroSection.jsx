...
const HeroSection = () => {
    ...
    return (
        <div className='bg-gradient-to-br from-white via-blue-50 to-blue-100 text-center min-h-screen w-full overflow-x-hidden flex items-center py-8 md:py-0 relative'>
            <style>{`
                ...
                .search-input:focus { transition: all 0.3s ease; box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1); }
            `}</style>
            ...
            <main className='flex flex-col md:flex-row mx-auto max-w-6xl w-full px-4 md:px-8 gap-8 md:gap-12 z-0'>
                <div className='flex flex-col gap-6 justify-center flex-1 z-0'>
                    <h1 className='hero-title text-3xl md:text-5xl lg:text-6xl text-left font-bold text-gray-900 leading-tight'>
                        Discover, Apply & <br /> Get The Career Of Your <span className='bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent'>Dreams</span>
                    </h1>
                    <p className='hero-subtitle text-base md:text-lg lg:text-xl text-gray-600 my-2'>
                        Connect with top institutions and land your ideal academic role. Showcase your expertise and get discovered by leading organizations.
                    </p>                    
                    <div className='flex flex-col gap-4 hero-search'>
                        <div className='flex w-full shadow-xl border-2 border-white pl-3 md:pl-4 rounded-full items-center gap-2 bg-white hover:shadow-2xl transition-all duration-300 cursor-text'>
                            <Search className='h-5 w-5 text-blue-500 flex-shrink-0 transition-colors duration-300' />
                            <input  
                                type="text"
                            ...
                            />  
                            <Button onClick={searchJobHandler} className="rounded-r-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 px-3 md:px-6 transition-all duration-300 active:scale-95 shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40">
