...
const JobDescription = () => {
    ...
    return (
        <>
        <Navbar/>
        <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 min-h-screen py-8 md:py-12">
            <div className="max-w-6xl mx-auto px-4 py-6 md:py-12 space-y-6 md:space-y-8">
                ...
                <div className="space-y-3 md:space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white rounded-lg md:rounded-2xl p-4 md:p-8 shadow-lg border border-purple-100">
                        <div className="space-y-2 flex-1 w-full">
                            ...
                            <div className="flex flex-wrap gap-2 mt-2 md:mt-3">
                                ...
                                <Badge variant="outline" className="bg-pink-100 text-pink-700 border-pink-300 text-xs md:text-sm">
                ...
                <div className="bg-white rounded-lg md:rounded-2xl p-4 md:p-8 shadow-lg border border-blue-100">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-3 md:p-4 rounded-lg md:rounded-xl border border-purple-200">
                        ...
                        <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-3 md:p-4 rounded-lg md:rounded-xl border border-pink-200">
                ...
                {/* Description */}
                <div className="bg-white rounded-lg md:rounded-2xl p-4 md:p-8 shadow-lg border border-purple-100">
                ...
                {/* Requirements */}
                <div className="bg-white rounded-lg md:rounded-2xl p-4 md:p-8 shadow-lg border border-pink-100">
                    <h2 className="text-lg md:text-2xl font-bold text-gray-900 mb-3 md:mb-4 flex items-center gap-2">
                        ✅ Requirements
                    </h2>
